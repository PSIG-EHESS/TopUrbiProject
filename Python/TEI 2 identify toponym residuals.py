    ...
    for entry_match in entries:
        ...
        for tag in tag_list:
            ...
            for match in matches:
                ...
                data.append((entry_id, tag, value, value_with_tag, context_left_stripped, context_right_stripped))  

    # Write to CSV
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(['xml:id', 'Tag', 'Match Value', 'Match Value with Tag', 'Context_Left', 'Context_Right', 'Place Type'])
...
for filename in filename_list:
    if __name__ == "__main__":
        ...
        output_file = rootpath+filename+'residuals.csv'
