...
#regionlist = ['Maracaibo','Tierra Firme','Nueva Vizcaya','Quivira','Collado','Santa Cruz de la Sierra','Nuevo Reyno de Granada']
regionlist = ['CHL','GUA']
...
dfB =  pd.read_csv(csvmatching_path, sep=';', dtype={"gz_id": "string", "label": "string", "nombre": "string", "var1": "string", "var2": "string", "var3": "string", "var4": "string", "nombrehoy": "string", "Tipo": "string", "Partido": "string", "Provincia": "string", "REG": "string", "Pais": "string", "Lat": "string", "Lon":"string", "matched":"string"})
            ...
            if dfA.loc[i,'matchingregion']==region and dfA.loc[i,'Match'] == "none":
                ...
                for i in range(0,dfB.shape[0]):
                    if dfB.loc[i,'REG']==region and dfB.loc[i,'matched']=="no":
                        ...
                        toponymB2 = stopwordremove(toponymB2)
                        toponymB3 = stopwordremove(toponymB3)
                        toponymB4 = stopwordremove(toponymB4)
                        toponymB5 = stopwordremove(toponymB5)
                        toponymB6 = stopwordremove(toponymB6)
...
##                            writer.writerow(["Step Ia2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step Ia3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step Ia5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step Ia6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##
...
##                            writer.writerow(["Step IIa2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IIa3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toponymA2 == toponymB and (distprovratio >85 or distdistratio > 85 or provdistratio >85):
##                            writer.writerow(["Step IIa4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toponymA2 == toponymB2 and (distprovratio >85 or distdistratio > 85 or provdistratio >85):
##                            writer.writerow(["Step IIa5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IIa6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##
...
##                            writer.writerow(["Step IIIa2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IIIa3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio3),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio7 > 85 and (districtA==provinceB or districtA==districtB or provinceA == districtB):
##                            writer.writerow(["Step IIIa4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio7),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio8 > 85 and (districtA==provinceB or districtA==districtB or provinceA == districtB):
##                            writer.writerow(["Step IIIa5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio8),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IIIa6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio9),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IVa2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IVa3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio3),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio7 > 85 and (distprovratio >85 or distdistratio > 85 or provdistratio >85):
##                            writer.writerow(["Step IVa4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio7),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio8 > 85 and (distprovratio >85 or distdistratio > 85 or provdistratio >85):
##                            writer.writerow(["Step IVa5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio8),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IVa6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio9),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##
...
##                            writer.writerow(["Step Ib2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toponymA == toponymB3 or toponymA == toponymB4 or toponymA == toponymB5 or toponymA == toponymB6)  and (provinceA == provinceB):
##                            writer.writerow(["Step Ib3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toponymA2 == toponymB and (provinceA == provinceB):
##                            writer.writerow(["Step Ib4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toponymA2 == toponymB2 and (provinceA == provinceB):
##                            writer.writerow(["Step Ib5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
...
##                            writer.writerow(["Step IIb2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toponymA == toponymB3 or toponymA == toponymB4 or toponymA == toponymB5 or toponymA == toponymB6)  and (provprovratio > 85):
##                            writer.writerow(["Step IIb3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
...
##                            writer.writerow(["Step IIb5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toponymA2 == toponymB3 or toponymA == toponymB4 or toponymA == toponymB5 or toponymA == toponymB6)  and (provprovratio > 85):
##                            writer.writerow(["Step IIb6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,"100",LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##
...
##                            writer.writerow(["Step IIIb2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio3 > 85 or toporatio4 > 85 or toporatio5 > 85 or toporatio6 > 85)  and (provinceA == provinceB):
##                            writer.writerow(["Step IIIb3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio3),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio7 > 85 and (provinceA == provinceB):
##                            writer.writerow(["Step IIIb4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio7),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio8 > 85 and (provinceA == provinceB):
##                            writer.writerow(["Step IIIb5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio8),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio9 > 85 or toporatio10 > 85 or toporatio11 > 85 or toporatio12 > 85)  and (provinceA == provinceB):
##                            writer.writerow(["Step IIIb6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio9),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##
...
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio1 > 85 and (provprovratio > 85):
##                            writer.writerow(["Step IVb2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio3 > 85 or toporatio4 > 85 or toporatio5 > 85 or toporatio6 > 85)  and (provprovratio > 85):
##                            writer.writerow(["Step IVb3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio3),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio7 > 85 and (provprovratio > 85):
##                            writer.writerow(["Step IVb4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio7),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio8 > 85 and (provprovratio > 85):
##                            writer.writerow(["Step IVb5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio8),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio9 > 85 or toporatio10 > 85 or toporatio11 > 85 or toporatio12 > 85)  and (provprovratio > 85):
##                            writer.writerow(["Step IVb6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio9),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
                            
#missed algorithm
                        if toporatio2 > 85 and (provprovratio > 85):
                            writer.writerow(["Step IVb2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
###only matchingregion
##                        elif toporatio1 ==100:
...
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio1 >85:
##                            writer.writerow(["Step RegB1",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio2 ==100:
##                            writer.writerow(["Step RegA2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio1),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif toporatio2 >85:
##                            writer.writerow(["Step RegB2",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio2),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio3 ==100 or toporatio4 ==100 or toporatio5 ==100 or toporatio6 ==100):
##                            writer.writerow(["Step RegA3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio3),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio7 ==100:
##                            writer.writerow(["Step RegA4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio7),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio8 ==100:
##                            writer.writerow(["Step RegA5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio8),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio9 ==100 or toporatio10 ==100 or toporatio11 ==100 or toporatio12 ==100):
##                            writer.writerow(["Step RegA6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio9),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio3 > 85 or toporatio4 > 85 or toporatio5 > 85 or toporatio6 > 85):
##                            writer.writerow(["Step RegB3",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio3),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio7 > 85:
##                            writer.writerow(["Step RegB4",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio7),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")                            
##                        elif toporatio8 > 85:
##                            writer.writerow(["Step RegB5",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio8),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
##                        elif (toporatio9 > 85 or toporatio10 > 85 or toporatio11 > 85 or toporatio12 > 85):
##                            writer.writerow(["Step RegB6",idA,idB,toponymA,toponymB,typeA,typeB,districtA,districtB,provinceA,provinceB,str(toporatio9),LatB,LonB])
##                            print(toponymA+", "+toponymB+" in "+districtB+", "+provinceB+" matched!")
