...
csvmatching_path = 'F:\\EHESS\\Workbench\\processing\\Input\\ref_usa_osm.csv'
...
dfB = pd.read_csv(csvmatching_path, sep=';', dtype={"osm_id": "string", "name": "string", "place": "string", "county": "string", "state": "string", "state_grp": "string"})

# Print column names to check if they are loaded correctly
print("dfA columns:", dfA.columns)
print("dfB columns:", dfB.columns)

with open("F:\\EHESS\\Workbench\\processing\\Output\\alcedo_usa_osm_matches.csv", 'w+', newline='', encoding="utf-8") as csvfile:
